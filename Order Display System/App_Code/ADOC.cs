...
public class ADOC
{
    ...
    public void writeToLogFile( string Events, string logMessage)
    {
  ...
  /// 
    ...
    public bool SendEmail(string To, string subject, string MailBody)
    {
    ...
    public bool IsValidEmailAddress(string InputEmailAddress)
    {
        return Regex.IsMatch(InputEmailAddress, @"[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z_+])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9}$");
    }

    public DataTable RemoveDuplicate(DataTable dTable, string colName)
    {
